...
import kapp.room.student.adapters.EmployeeAdapter;
...
public class EmployeeFragment extends Fragment implements View.OnClickListener{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new EmployeeAdapter(list);
        mRecyclerView.setAdapter(mAdapter);

        mUIViewModel.getAllEmployees().observe(this, new Observer<List<Employee>>() {
            @Override
